...
var refresh = function() {
  ...
  if (simple_prefs.prefs.mode == 'minWidth') {
    setDevPixelsPerPx(setMinWidthMode(window.screen.availWidth, parseFloat(simple_prefs.prefs.pixelRatioStr)));
  }
  else {
    setDevPixelsPerPx(setExactScreenSizeMode(window.screen.availWidth, window.screen.availHeight, parseFloat(simple_prefs.prefs.pixelRatioStr)));
  }
};
